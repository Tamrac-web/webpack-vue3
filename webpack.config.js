...
const config = {
  ...
  output: {
    ...
    filename: "js/chunk-[contenthash:8].js", // 这样的意思是 js 文件都会放在 js目录下 并且使用 chunk + hash的方式进行命名
...
// 开发服务器
  ...
  plugins: [
    ...
    new MiniCssExtractPlugin({
      filename: "styles/chunk-[contenthash:8].css", // 将css代码输出到 输出目录/styles文件夹下 也是以 chunk + hash的方式
